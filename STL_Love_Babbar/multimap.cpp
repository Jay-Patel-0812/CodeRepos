...
int main()
{
    ...
    // 5
    cout << "gquiz1.lower_bound(4) : "
         << "\tKEY = ";
    cout << gquiz1.lower_bound(4)->first << '\t';
    cout << "\tELEMENT = " << gquiz1.lower_bound(4)->second
         << endl;
    cout << "gquiz1.upper_bound(4) : "
         << "\tKEY = ";
    cout << gquiz1.upper_bound(4)->first << '\t';
    cout << "\tELEMENT = " << gquiz1.upper_bound(4)->second
         << endl;
